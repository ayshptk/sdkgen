...
var keys = {};
try {
    keys = require(path_1.default.resolve(__dirname, "sdkgen_keys.json"));
}
catch (e) {
    console.log(chalk_1.default.yellow("SDK keys not found.Creating blank config"));
...
inquirer_1.default
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, handler_1.handler)(answers, keys)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
